const cfg = window.EITEL_UI_CONFIG || {};
    ...
    const i18n = {
      es: {
        ...
        'catalog.title': 'Escaparate del catálogo', 'catalog.subtitle': 'Explora assets en tarjetas tipo revista y contrata solo cuando selecciones uno.', 'catalog.connector': 'Conector remoto', 'catalog.dsp': 'URL DSP', 'catalog.load': 'Ver catálogos', 'catalog.refresh': 'Actualizar', 'catalog.assetToContract': 'Asset a contratar', 'catalog.requestContract': 'Pedir contrato por asset', 'catalog.listRequests': 'Ver solicitudes', 'catalog.requests': 'Solicitudes',
      ...
      en: {
        ...
        'catalog.title': 'Catalog showcase', 'catalog.subtitle': 'Explore assets in magazine-style cards and contract only after selecting one.', 'catalog.connector': 'Remote connector', 'catalog.dsp': 'DSP URL', 'catalog.load': 'Load catalogs', 'catalog.refresh': 'Refresh', 'catalog.assetToContract': 'Asset to contract', 'catalog.requestContract': 'Request contract by asset', 'catalog.listRequests': 'List requests', 'catalog.requests': 'Requests',
