const cfg = window.EITEL_UI_CONFIG || {};
    ...
    const i18n = {
      es: {
        ...
        'catalog.title': 'Catalogo de activos', 'catalog.subtitle': 'Consulta activos disponibles, aplica filtros y prepara la contratacion.', 'catalog.connector': 'Conector remoto', 'catalog.dsp': 'URL DSP', 'catalog.load': 'Ver catalogos', 'catalog.refresh': 'Actualizar', 'catalog.assetToContract': 'Asset a contratar', 'catalog.requestContract': 'Pedir contrato por asset', 'catalog.listRequests': 'Ver solicitudes', 'catalog.requests': 'Solicitudes',
